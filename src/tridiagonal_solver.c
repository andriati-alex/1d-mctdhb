...
/** Solve system of equations from cyclic tridiagonal matrix  that  arises
  * from finite-differences of PDEs with periodic boudary conditions.  See
  *
  * Thiab R. Taha,  "Solution of Periodic Tridiagonal  Linear  Systems  of
  * Equations on a Hypercube", Proceedings of the Fifth Distributed Memory
  * Computing Conference, Charleston, SC, 1990, Vol 1, p. 346-350      **/
...
/** Solve a cyclic tridiagonal system of equations unsing Sherman-Morrison
  * formula that suppose we now how to solve a  very  similar  system (the
  * tridiagonal in this case) to make changes in few entries of the matrix
  *
  * See "Numerical Recipes in C", section 2.7
  *
  * Cyclic elements are given by the last elements of upper and lower
  * bottom == lower[n-1];
  * top    == upper[n-1];
  *
**/
